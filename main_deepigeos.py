...
class MainDialog(QDialog):
    ...
    def initUI(self):
        ...
        self.pn = 1
        self.flag = 0
        self.b_h, self.b_w = (660, 500) 
        self.count = 0
        self.ax = 0
        self.W, self.H = (0, 0)
        self.clk = pyqtSignal(float, float)
        self.img_file_names = ""
        self.seg_file_names = ""
    ...
    def Button_click(self):
        ...
        self.imgs = nib.load(self.img_file_names[0]).get_fdata()
    ...
    def Button6_click(self):
        ...
        self.segs = nib.load(save_path_pnet).get_fdata()
    ...
    def Button7_click(self):
        ...
        self.segs = nib.load(save_path_rnet).get_fdata()
        self.img, self.seg = nextImage(self.usrId, self.imgs, self.segs, self.ax, self.count, pn=self.pn)
        self.label.setText('COMPLETE, Click Axis') #텍스트 변환 
        self.label.setFont(QtGui.QFont("궁서",30)) #폰트,크기 조절 
        self.label.setStyleSheet("Color : black") #글자색 변환
